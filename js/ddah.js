function showInfo(data, tabletop) {
  ...
  $.each( tabletop.sheets(), function(i, sheet) 
  {
    ...
    for(i = 0; i < rows; i++ ) 
    {
      ...
      $(".fila"+fila).append("<div class='col-md-3'><div class='cajita'><span class='area'>"+area+"</span><ul id='social'><li>"+twitter+"</li></ul><h2 id='title'>"+promesa+"</h2><p class='detail'>"+min_detail+view_more+"</p><ul id='type'>"+tipo+"</ul></div>"+modal+"</div>");
